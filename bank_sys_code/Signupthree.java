...
public class Signupthree extends JFrame implements ActionListener {// ActionListener → to handle button click actions
    ...
    Signupthree(String formno) {    // constructor initializes the frame, UI components, and form number
        ...
        r1.setBounds(100, 180, 250, 25);
        add(r1);

        r2 = new JRadioButton("Fixed Deposite Account ");
        r2.setFont(new Font("Raleway", Font.BOLD, 16));
        r2.setBackground(Color.WHITE);
        r2.setBounds(350, 180, 250, 25);
        add(r2);

        r3 = new JRadioButton("Current Account");
        r3.setFont(new Font("Raleway", Font.BOLD, 16));
        r3.setBackground(Color.WHITE);
        r3.setBounds(100, 220, 250, 25);
        add(r3);
        ...
        submit.addActionListener(this);// add click listener so actionPerformed() runs when submit button is clicked.
        add(submit);
        ...
        cancel.addActionListener(this);// add click listener so actionPerformed() runs when submit button is clicked.

        add(cancel);

        getContentPane().setBackground(Color.WHITE);// frame color is white
